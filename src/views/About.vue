    ...
    <div class="about-container">
      ...
      <el-card class="app-info-card" shadow="hover">
        <div class="app-header">
          <div class="app-icon">
            <img
              :src="baseUrl + 'icons/app-icon.png'"
              alt="Multi Social Platform"
            />
          </div>
        ...
        <div class="app-description">
          <p>
            Multi Social Platform 是一个基于 Electron 和 Vue.js
            开发的多平台社交软件管理器。
      ...
      <el-card class="team-card" shadow="hover">
        ...
        <div class="team-content">
          <div class="team-member">
            <el-avatar :size="60" :src="baseUrl + 'icons/developer.png'">
            ...
            <div class="member-info">
              ...
              <div class="member-links">
                <el-button
                  link
                  @click="openLink('https://github.com/developer')"
                >
                ...
                <el-button
                  link
                  @click="openLink('mailto:developer@example.com')"
                >
      ...
      <el-card class="license-card" shadow="hover">
        ...
        <div class="license-content">
          <div class="license-info">
            <p><strong>开源许可证:</strong> MIT License</p>
            <p><strong>版权所有:</strong> © 2024 Multi Social Platform</p>
          </div>
          ...
          <div class="useful-links">
            ...
            <div class="links-grid">
              <el-button
                @click="
                  openLink('https://github.com/project/multi-social-platform')
                "
                plain
              >
                <el-icon><Link /></el-icon>
              ...
              <el-button
                @click="
                  openLink(
                    'https://github.com/project/multi-social-platform/issues'
                  )
                "
                plain
              >
              ...
              <el-button
                @click="
                  openLink(
                    'https://github.com/project/multi-social-platform/releases'
                  )
                "
                plain
              >
      ...
      <el-card class="update-card" shadow="hover">
        ...
        <div class="update-content">
          <div class="update-status">
            <el-icon v-if="updateStatus === 'checking'" class="is-loading"
              ><Loading
            /></el-icon>
            <el-icon v-else-if="updateStatus === 'available'" color="#E6A23C"
              ><Warning
            /></el-icon>
            <el-icon v-else-if="updateStatus === 'error'" color="#F56C6C"
              ><Close
            /></el-icon>
  ...
  try {
    ...
    if (window.nodeAPI && window.nodeAPI.versions) {
      ...
      systemInfo.electronVersion =
        window.nodeAPI.versions.electron || "Unknown";
...
const loadStats = () => {
  try {
    ...
    const containers = JSON.parse(
      localStorage.getItem("app-containers") || "[]"
    );
    stats.totalContainers = containers.length;
    stats.activeContainers = containers.filter(
      (c) => c.status === "ready"
    ).length;
